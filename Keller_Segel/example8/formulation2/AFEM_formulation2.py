...
for k in range(nt):
    ...
    while True:
        ...
        if refine_count == 0:
            ...
            errordown = abs(error1 - error0)/error0
        
        relative_error = (errU/uh_grad_norm + errV/vh_grad_norm)/2
        #( errU/uh_grad_norm < tol1) | (errV/vh_grad_norm < tol1)
        print('errordown',errordown)
        #if (errordown > 0.15) | (refine_count > 20) | (relative_error < tol1):
