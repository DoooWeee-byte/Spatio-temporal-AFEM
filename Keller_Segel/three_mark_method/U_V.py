...
plt.savefig('U_V/test-' +  '-t1-' + str(0) + '-dof-'+ str(space.number_of_global_dofs()) + '.pdf')
plt.close()
...
plt.savefig('U_V/uh-'+'-t1-' + str(0) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
plt.close()
...
plt.savefig('U_V/vh-'+'-t1-' + str(0) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
plt.close()
...
while tn < T:
    ...
    if  (abs(tn - tend)< 1e-15):
        ...
        plt.savefig('U_V/test-' +  '-t1-' + str(tn) + '-dof-'+ str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.title(f"t = {tn}", fontsize=24, loc='center',color='k')
        uh0.add_plot(plt,cmap='rainbow')
        plt.savefig('U_V/uh-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.title(f"t = {tn}", fontsize=24, loc='center',color='k')
        vh0.add_plot(plt,cmap='rainbow')
        plt.savefig('U_V/vh-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.savefig('eta_UV/etaV-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.savefig('eta_UV/etaU-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.savefig('eta_UV/etaVU-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
