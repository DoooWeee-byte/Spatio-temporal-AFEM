...
plt.savefig('V/test-' +  '-t1-' + str(0) + '-dof-'+ str(space.number_of_global_dofs()) + '.pdf')
plt.close()
...
plt.savefig('V/uh-'+'-t1-' + str(0) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
plt.close()
...
plt.savefig('V/vh-'+'-t1-' + str(0) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
plt.close()
...
while tn < T:
    ...
    if  (abs(tn - tend)< 1e-15):
        ...
        plt.savefig('V/test-' +  '-t1-' + str(tn) + '-dof-'+ str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.title(f"t = {tn}", fontsize=24, loc='center',color='k')
        uh0.add_plot(plt,cmap='rainbow')
        plt.savefig('V/uh-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.title(f"t = {tn}", fontsize=24, loc='center',color='k')
        vh0.add_plot(plt,cmap='rainbow')
        plt.savefig('V/vh-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.savefig('eta_V/etaV-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.savefig('eta_V/etaU-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
        ...
        plt.savefig('eta_V/etaVU-'+'-t1-' + str(tn) +'-dof-' + str(space.number_of_global_dofs()) + '.pdf')
        plt.close()
